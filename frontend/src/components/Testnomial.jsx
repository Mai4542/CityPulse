        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed mb-5 text-sm">
              "بلّغت عن حفرة في شارعنا وتم إصلاحها خلال ٣ أيام فقط! خدمة رائعة."
            </p>
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-black text-slate-800 text-sm">أحمد مصطفى</p>
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed mb-5 text-sm">
              "فخور بوجود منصة بهذا التطور في محافظتنا. الاستجابة سريعة والفرق
              محترفة."
            </p>
            <div className="flex items-center gap-3">
              <img
              ...
              <div>
                <p className="font-black text-slate-800 text-sm">محمود السيد</p>
