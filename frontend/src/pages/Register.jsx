      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-[1fr_1.1fr] items-center px-2 md:px-6 lg:px-10 gap-12 md:gap-16 lg:gap-32 mx-auto">
        ...
        <div className="w-full max-w-[385px] mx-auto md:justify-self-start scale-[1.02] transition-transform">
          ...
          <div className="bg-[#12343a]/80 border border-white/10 p-6 rounded-[26px] backdrop-blur-2xl w-full shadow-2xl">
            ...
            <form className="space-y-3.5" dir="rtl" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <label className="text-sm text-gray-300 font-medium">الاسم الأول</label>
                  <input type="text" name="firstName" value={formData.firstName} onChange={handleChange} placeholder="محمد" className="w-full bg-[#1a3c42]/90 border border-white/10 rounded-2xl py-3 px-4 text-sm text-gray-200 focus:outline-none focus:border-primary transition-all placeholder:text-gray-500" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-sm text-gray-300 font-medium">الاسم الثاني</label>
                  <input type="text" name="lastName" value={formData.lastName} onChange={handleChange} placeholder="أحمد" className="w-full bg-[#1a3c42]/90 border border-white/10 rounded-2xl py-3 px-4 text-sm text-gray-200 focus:outline-none focus:border-primary transition-all placeholder:text-gray-500" />
                </div>
              </div>

              <div className="space-y-1.5">
                <label className="text-sm text-gray-300 font-medium">رقم الهاتف</label>
                <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="01xxxxxxxxx" className="w-full bg-[#1a3c42]/90 border border-white/10 rounded-2xl py-3 px-4 text-sm text-left font-sans text-gray-200 focus:outline-none focus:border-primary transition-all placeholder:text-gray-500" />
              </div>

              <div className="space-y-1.5">
                <label className="text-sm text-gray-300 font-medium">البريد الإلكتروني</label>
                <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="example@mail.com" className="w-full bg-[#1a3c42]/90 border border-white/10 rounded-2xl py-3 px-4 text-sm text-left font-sans text-gray-200 focus:outline-none focus:border-primary transition-all placeholder:text-gray-500" />
              </div>

              <div className="space-y-1.5">
                <label className="text-sm text-gray-300 font-medium">كلمة المرور</label>
                <div className="relative flex items-center">
                  <input type={showPassword ? "text" : "password"} name="password" value={formData.password} onChange={handleChange} placeholder="••••••••" className="w-full bg-[#1a3c42]/90 border border-white/10 rounded-2xl py-3 pl-11 pr-4 text-sm font-sans text-gray-200 focus:outline-none focus:border-primary transition-all placeholder:text-gray-500" />
              ...
              <button type="submit" className="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 rounded-2xl transition-all shadow-md text-sm mt-4">التالي</button>
            </form>
        ...
        <div className="hidden md:flex flex-col items-start text-right space-y-6 w-full max-w-[450px] md:justify-self-end relative" dir="rtl">
          ...
          <div className="space-y-2 w-full mt-24">
          ...
          <div className="grid grid-cols-3 gap-3.5 w-full pt-35">
