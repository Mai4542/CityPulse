...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-[#fafbfc] font-main text-right" dir="rtl">
      {/* Navbar */}
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 px-6 py-4 md:px-12 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-3 text-right">
            <div className="bg-[#00b097] text-white font-bold p-2.5 rounded-xl flex items-center justify-center w-11 h-11 text-lg">
              CP
            </div>
            <div className="flex flex-col justify-center">
              <h1 className="leading-tight text-[19px] font-bold text-[#072a33]">CityPulse</h1>
              <p className="text-[11px] text-gray-400 font-normal leading-none mt-0.5">محافظة القليوبية</p>
            </div>
          </div>
        </div>

        <nav className="hidden md:flex items-center gap-8 text-[#374151] font-medium text-[15px]">
          <a href="#" className="hover:text-[#00b097] transition">المميزات</a>
          <a href="#" className="hover:text-[#00b097] transition">كيف يعمل</a>
          <a href="#" className="text-[#00b097] font-bold border-b-2 border-[#00b097] pb-2 px-1">الأسئلة الشائعة</a>
          <a href="#" className="hover:text-[#00b097] transition">تواصل معنا</a>
        </nav>

        <div className="flex items-center gap-3">
          <button className="text-[#00b097] bg-[#00b097]/5 border border-[#00b097]/20 hover:bg-[#00b097]/10 text-[14px] font-bold px-5 py-2.5 rounded-xl transition">
            تسجيل الدخول
          </button>
          <button className="bg-[#00b097] hover:bg-[#009c86] text-white text-[14px] font-bold px-6 py-2.5 rounded-xl shadow-sm transition">
            ابدأ الآن
          </button>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden bg-[radial-gradient(circle_at_center,_#0d3d3d_0%,_#072a33_45%,_#041626_100%)] text-white text-center pt-14 pb-12 px-4">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12 -mt-6 relative z-20">
        ...
        <div className="mt-12 bg-gradient-to-r from-[#072a33] to-[#00b097] rounded-2xl p-8 text-center text-white shadow-md relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <a 
              href="#" 
              className="bg-white text-[#072a33] hover:bg-gray-50 hover:text-[#00b097] px-6 py-2.5 rounded-xl font-bold text-sm inline-flex items-center gap-2 shadow-sm transition duration-200"
            >
      ...
      {/* Footer */}
      <footer className="bg-[#041626] text-gray-500 text-center py-6 text-xs border-t border-white/5">
        <p>© ٢٠٢٦ CityPulse — محافظة القليوبية. جميع الحقوق محفوظة.</p>
      </footer>
    </div>
  );
}   